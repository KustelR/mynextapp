    ...
    <nav className="flex h-fit items-end bg-primary text-white text-2xl w-full place-content-between shadow-inner border-bottom border-neutral-200 border-b-2 dark:border-transparent dark:bg-neutral-700 p-1">
      <div className="flex h-fit justify-between md:justify-normal">
        ...
        <div className="md:flex items-end w-fit">
          <h1 className=" md:ml-3 mr-3 md:hover:rotate-1 md:hover:scale-105 text-6xl">
            <NextLink className="font-bold" href="/">
              KUST
            </NextLink>
          </h1>
          <ul className={navbarClasses}>
            <li className={navbarItemClasses + " block md:hidden"}>
            ...
            <li className={navbarItemClasses}>
              <Link to="/app/browse">Read</Link>
            </li>
            <li className={navbarItemClasses}>
              <Link to="/app/article/write">Write</Link>
            </li>
            <li className={navbarItemClasses}>
            ...
            <li className={navbarItemClasses + " block md:hidden"}>
              <Link to="app/login">Log in / Sign up</Link>
            </li>
            <li
              className={navbarItemClasses + " block md:hidden"}
              onClick={() => {
                localStorage.clear();
      ...
      <div className="flex md:items-end">
        ...
        <div className="hidden md:block md:mr-6">
          <CustomInput className="text-black" placeholder="Search..." />
        </div>
        <ImageButton
          onClick={toggleTheme}
          className="h-9 w-9 relative items-center"
        >
