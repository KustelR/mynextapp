...
const LikeCounter = React.lazy(() =>
  import("@/components/articles/LikeCounter")
);
...
export default function Article(props) {
  ...
  return (
    <div
      className={
        "container md:shadow-lg max-w-screen-md mx-auto p-4 border-2 border-neutral-50 dark:border-neutral-700 " +
        className
      }
    >
