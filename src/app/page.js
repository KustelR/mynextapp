...
export default function Home() {
  return (
    <main>
      <div className={pageClassnames}></div>
      <div className="md:fixed md:w-full"></div>
      <div className="relative h-screen">
          ...
          <div className=" flex mt-8 bg-white text-3xl md:text-lg md:w-fit shadow-2xl">
            ...
            <div className="m-3">
              ...
              <ul className="[&>*]:mb-8 md:[&>*]:mb-0">
                <li className="hover:bg-gray-100 px-1 dark:hover:bg-neutral-600 rounded-md">
                  <Link href="/app">Get started</Link>
                </li>
                <li className="hover:bg-gray-100 px-1 dark:hover:bg-neutral-600 rounded-md">
                  <Link href="/app/login">Login / Sign up</Link>
                </li>
                <li className="hover:bg-gray-100 px-1 dark:hover:bg-neutral-600 rounded-md">
        ...
        <div className=" -z-10 md:absolute bottom-0 text-neutral-500 text-center w-screen text-sm">
          Image by{" "}
          <a href="https://www.pexels.com/@quintingellar/">Quintin Gellar</a>
        </div>
      </div>
    </main>
  );
